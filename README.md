...
# Meeting 1:
  ...
  Tegen volgende meeting (19/10/2015 : 16h):
    ...
    - <s>Hoe merge conflicts oplossen in VS.</s>
    - <s>Errors in C, vb. verkeerd opgestelde file om level-struct van te maken.</s>
    - level.c:init_level(): nodig voor free(cell)? + level.c:level_free(): voldoende ?
    - <s>GUI aan level object geraken om vorige level te free'en.</s>
